...
import com.devsuperior.myfirtsproject.entities.Product;
import com.devsuperior.myfirtsproject.repository.CategoryRepository;
import com.devsuperior.myfirtsproject.repository.ProductRepository;
...
public class MyfirtsprojectApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Product p4 = new Product(null, "Docker", 100.0, cat2);
